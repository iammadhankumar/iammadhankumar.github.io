  ...
  return (
    <>
      <article
        className="
          font-sans
          w-full max-w-[650px]   /* ≈ Google blog width */
          mx-auto
          ...
          space-y-6              /* 24 px rhythm */
          overflow-x-hidden
        "
        style={{
          fontSize: "clamp(1rem, 2.8vw, 1.125rem)", // 16–18 px
          textWrap: "pretty",
          hyphens: "auto",
        }}
      >
        ...
        <div className="space-y-2">
          ...
          <Skill
            label="Frameworks"
            value="Spring Boot, Hibernate, Servlet, Angular, Python-Flask"
          />
          <Skill
            label="Databases"
            value="MySQL, PostgreSQL, MicrosoftSQL, MongoDB"
          />
          <Skill label="Cloud" value="AWS (EC2, S3, Lambda, RDS)" />
          <Skill
            label="Tools & Platforms"
            value="Git, Jenkins, Postman, Docker"
          />
        ...
        <div className="space-y-2">
          <Skill
            ...
            value="I enjoy breaking down complex problems and finding simple, effective solutions."
          />
          <Skill
            label="Team Collaboration"
            value="I work well with others and believe that the best results come from strong teamwork and shared goals."
          />
          <Skill
            label="Communication"
            value="I'm comfortable expressing ideas clearly, whether in writing or conversation, and I value open, honest communication."
          />
          <Skill
            label="Adaptability"
            value="I'm comfortable adapting to new tools and technologies and enjoy finding smarter ways to work."
          />
        </div>
      ...
      {/* --- Scoped heading sizes (Google blog style) --- */}
      <style>{`
        .section-h2 {
          font-size: 1.25rem;          /* ≈20 px phones */
          font-weight: 600;
          margin-top: 2.5rem;
          margin-bottom: 1rem;
          line-height: 1.4;
...
/* Reusable Skill row – content unchanged */
